    ...
    ui(new Ui::CALL)
{
    ...
    connect(readCommandService,SIGNAL(BT_Phone_pickDown()),this,SLOT(revicerFinishUpdateShow()));
...
void CALL::on_pushButton_callphone_clicked()
{
...
void CALL::on_pushButton_delete_clicked()
{
    QString phoneNumberString ="";
...
void CALL::on_pushButton_number1_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
...
void CALL::on_pushButton_number2_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number3_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number4_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number5_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number6_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number7_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number8_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number9_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_star_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_number0_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_sign_clicked()
{
    QString phoneNumberString ="";
    phoneNumberString = ui->label_phoneNumber->text();
    if (phoneNumberString.length() < 20)
...
void CALL::on_pushButton_open_or_close_clicked()
{
...
void CALL::on_pushButton_play_or_stop_clicked()
{
...
void CALL::on_pushButton_stop_clicked()
{
    char tmp[100] = {0};
...
void CALL::on_pushButton_vol_clicked()
{
...
void CALL::on_pushButton_PreSong_clicked()
{
    char tmp[100] = {0};
...
void CALL::on_pushButton_nextSong_clicked()
{
    char tmp[100] = {0};
...
void CALL::OnComingcallShow(QString phoneNumber)
{
...
void CALL::OnOuttingcallShow(QString phoneNumber)
{
...
void CALL::OnContactsShow(QString NameString,QString phoneNumberString)
{
...
void CALL::revicerFinishUpdateShow()
{
    ...
    case 1:
        sleep(1);
        ui->tableView_records->clearSpans();
        RecordsCount = 0;
    ...
    default:
        setpStatus = 0;
        ui->tableView_records->sortByColumn(3,Qt::DescendingOrder);
        break;
    }
}

bool CALL::getFinishStatus()
{
    return finishStatus;
}

void CALL::setFinishStatus(bool status)
{
    finishStatus = status;
}

void CALL::revicerRecordsShow(QString TypeString,QString NameString,QString PhoneString,QString TimeString)
{
...
void CALL::on_pushButton_Contacts_callPhone_clicked()
{
...
void CALL::revicerTableviewContactsClicked(const QModelIndex &index)
{
    qDebug()<<"OnTableview_ContactsClicked";
    Contacts_index = index;
}

void CALL::on_pushButton_recordCall_clicked()
{
...
void CALL::on_pushButton_disconnect_clicked()
{
    char tmp[100] = {0};
...
void CALL::revicerBT_Scan_INFO(QString BTDevAddrString,QString BTDevNameString)
{
    bool check = false;
...
void CALL::revicerBT_Connect_INFO(int row,QString BTDevAddrString,QString BTDevNameString)
{
...
void CALL::on_listWidget_MF_device_clicked(const QModelIndex &index)
{
    qDebug()<<"index.row() is " <<index.row();
    connect_index = index;
}

void CALL::on_listWidget_SF_Dev_doubleClicked(const QModelIndex &index)
{
...
void CALL::on_pushButton_page1_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void CALL::on_pushButton_page2_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);


//    ui->tableView_Contacts->clearSpans();
//    ContactsCount=0;
...
void CALL::on_pushButton_page3_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void CALL::on_pushButton_page4_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void CALL::on_pushButton_page5_clicked()
{
...
void CALL::on_pushButton_Contacts_update_clicked()
{
        setFinishStatus(false);
...
void CALL::on_pushButton_connect_clicked()
{
    QString bt_addr = connect_index.data().toString().left(12);
